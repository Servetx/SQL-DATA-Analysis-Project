...
Bu dashboard’da KPI kartları, önceki ay karşılaştırmaları, büyüme oranları ve seçili ay vurgulama işlemleri için DAX ölçüleri kullanılmıştır.

Kullanılan DAX ölçüleri dax Klasörün içindeki Metin Textinde measures.md.txt 
